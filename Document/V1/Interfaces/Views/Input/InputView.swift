...
class InputView: View {
    ...
    override func view_deploy() {
        ...
        title.textColor = Colors.text_hint_dark
        ...
        text.textColor = Colors.text_dark
        text.backgroundColor = Colors.gray_light
        text.frame = CGRect(
        ...
        cancel.setTitleColor(Colors.text_dark, for: .normal)
        ...
        save.setTitleColor(Colors.text_dark, for: .normal)
        save.setTitle("Save", for: .normal)
        save.addTarget(self, action: #selector(cancel_action), for: .touchUpInside)
        save.frame = CGRect(
